...
candidate_vote_count=[0,0,0]
candidate_vote_perc=[0,0,0]
...
candidate_vote_perc[0]=100*candidate_vote_count[0]/total_votes
candidate_vote_perc[1]=100*candidate_vote_count[1]/total_votes
candidate_vote_perc[2]=100*candidate_vote_count[2]/total_votes
...
print("-------------------------", file=f)
print(f"{candidate[0]}: {"%.3f" % candidate_vote_perc[0]}% ({candidate_vote_count[0]})", file=f)
print(f"{candidate[1]}: {"%.3f" % candidate_vote_perc[1]}% ({candidate_vote_count[1]})", file=f)
print(f"{candidate[2]}: {"%.3f" % candidate_vote_perc[2]}% ({candidate_vote_count[2]})", file=f)
print("-------------------------", file=f)
